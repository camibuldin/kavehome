  ...
  return (
    <main>
      <div className={styles.main}>
        {/* Título principal con rol heading */}
        ...
        <div className={styles.productsSection} role="region" aria-label="Lista de productos">
          {page.map(
            (item: any) =>
        ...
        <div className={styles.paginationContainer}>
          {totalPages > 1 && (
            <div className={styles.paginationDiv} role="navigation" aria-label="Paginación">
              {currentPage > 4 && (
                <button
              ...
              {Array.from({ length: endIndex - startIndex }, (_, index) => (
                <button
                  className={`${styles.paginationBtn} ${
                    currentPage === index + startIndex + 1 ? styles.selectedPage : ""
                  }`}
